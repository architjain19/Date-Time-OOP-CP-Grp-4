...
void givingChoises(){
	...
	cout<<" [2] View code authors"<<endl<<endl<<endl;
	unsigned int option=0;cout<<" Choosen option = ";cin>>option;
...
void codeAuthor(){
	cout<<endl<<"--------------------------------Clock Analogy - Date & Time--------------------------------------"<<endl<<endl; 
	cout<<" Choose option was Code Authors "<<endl<<endl;
	currentDateTime();
	cout<<"\n SY : PR - A" << endl << " Batch - 1\t" << " Group - 4\n" << " 07 - Shraddha Bharambe       " << "13 - Raj Gharte       " << "16 - Archit Jain       " << "22 - Adwait Kelkar       " << endl;
...
// pointers
// encapsulation
// time and system library
// itoa -> integer to string formatting concept
// constructors
// access modifiers
// buildin and userdefined functions
